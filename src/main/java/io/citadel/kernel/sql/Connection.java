...
record Connection<D extends Driver>(String protocol, String host, int port, String database, String username, String password, Class<D> driver) implements Database {
